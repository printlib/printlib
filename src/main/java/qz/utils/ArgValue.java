...
public enum ArgValue {
    ...
    // Actions
    ALLOW(ACTION,"Allow the certificate.", "--allow cert.pem", null,
          "--allow", "--whitelist", "-a"),
    BLOCK(ACTION, "Block the certificate.", "--block cert.pem", null,
          "--block", "--blacklist", "-b"),
    FILE_ALLOW(ACTION, "File operations have been disabled - this command is not available", "--file-allow /my/file/path [--sandbox \"Company Name\"]",  null,
          "--file-allow"),
    FILE_REMOVE(ACTION, "File operations have been disabled - this command is not available", "--file-remove /my/file/path", null,
               "--file-remove"),
    ...
    // Parameter stubs
    TRAY_HEADLESS(PREFERENCES, "Start U Print in headless (no user interface) mode", null, false,
        "tray.headless"),
    ...
    SECURITY_DATA_PROTOCOLS(PREFERENCES, "URL protocols allowed for print, serial, etc", null, "http,https",
